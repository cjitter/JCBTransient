...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 487.0, 651.0, 58.0, 62.0 ],
					"text" : "average~ 1000 @mode absolute"
				}
